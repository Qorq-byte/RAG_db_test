...
class PageShell(QWidget):
    def __init__(self, title: str, description: str = "") -> None:
        ...
        self.action_bar.setProperty("wetPaintEnabled", True)
        self.actions = QHBoxLayout(self.action_bar)
...
class DetailPanel(QWidget):
    ...
    def __init__(self) -> None:
        ...
        self.close_button.setToolTip("关闭详情面板")
        self.close_button.setAccessibleName("关闭详情面板")
